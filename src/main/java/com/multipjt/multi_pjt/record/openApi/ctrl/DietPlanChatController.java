...
public class DietPlanChatController {
    ...
    public DietPlanChatResponseDTO generateDietPlan(@RequestBody DietPlanChatRequestDTO request) {
        ...
        String userMessage = String.format(
            ...
            "|---------|---------|---------|-------------|------------|\n" +
            "| 아침 식사 | 스크램블 에그와 야채 | 2개, 야채 추가 | 300 | 단백질 20g, 지방 10g, 탄수화물 10g |\n" +
            "| 점심 식사 | 구운 닭고기 샐러드 | 150g, 다양한 채소 | 400 | 단백질 30g, 지방 15g, 탄수화물 20g |\n" +
            "| 저녁 식사 | 구운 연어와 현미 | 150g, 1컵 | 500 | 단백질 25g, 지방 10g, 탄수화물 30g |\n" +
            "| 간식     | 과일 | 1개 | 100 | 단백질 1g, 지방 0g, 탄수화물 20g |\n\n" +
            "**합계**\n" +
            "- 열량: 약 2200 kcal\n" +
            "- 단백질: 100~120g (변동 가능)\n\n" +
            "### **주의 사항:**(식단의 주의사항)\n" +
